...
// Compiled subplan for FilteringNLJoinChain([col0 = col2], [1 = 1], [1 = 1], 1 = 1)[FileScan(T),FileScan(R)]
printf("Evaluating subplan FilteringNLJoinChain([col0 = col2], [1 = 1], [1 = 1], 1 = 1)[FileScan(T),FileScan(R)]\n");
...
// originalterm=Term_T(o1,p2,o2) (position 1)
// symbol=V1
...
// originalterm=Term_R(s1,p1,o1) (position 0)
// symbol=V2
