...
def apply_schema_recursive(operator, catalog):
    """Given a catalog, which has a function get_scheme(string) to map a
    relation name to its scheme, update the schema for all scan operations that
    scan relations in the map."""
