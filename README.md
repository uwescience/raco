...
Raco has backend compilers that emit C++ and [Grappa](http://grappa.io) programs for query plans. To find out how it works in depth, read the [UW technical report](ftp://ftp.cs.washington.edu/tr/2014/10/UW-CSE-14-10-01.pdf).
